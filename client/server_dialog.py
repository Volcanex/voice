"""
Server Dialog for the Voice Assistant client.

Provides a UI for selecting and configuring server connections.
"""
import asyncio
import logging
...
class ServerSelectionDialog:
    ...
    def __init__(self, parent: tk.Tk, connection_manager: ConnectionManager, 
        ...
        logger.info("Server selection dialog initialized")
...
class ServerConfigDialog:
    ...
    def __init__(self, parent, connection_manager: ConnectionManager, 
        ...
        logger.info(f"Server config dialog initialized (is_new={is_new})")
